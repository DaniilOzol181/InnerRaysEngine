...
namespace smart_cover
{
	...
	{
		class animation_action : private boost::noncopyable
		{
		private:
			Fvector m_position;
		...
		public:
			animation_action(Fvector const& position, shared_str const& animation_id, MonsterSpace::EBodyState const& body_state,
