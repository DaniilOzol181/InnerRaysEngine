...
void xrServer::client_Destroy(IClient* C)
{
	...
	/*
	IClient* deleted_client = net_players.FindAndEraseDisconnectedClient(std::bind1st(std::equal_to<IClient*>(), C));
	*/
...
void xrServer::Update()
{
	...
	{
		client_Destroy(tmp_client);
		tmp_client = net_players.GetFoundDisconnectedClient(LongTimeClient::Searher);
	}
