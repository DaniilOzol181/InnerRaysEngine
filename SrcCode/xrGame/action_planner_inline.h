...
{
	VERIFY2(!m_solving, make_string("do not change effects during planner update, object %s, id[%d]",
		object_name(), condition_id));
...
{
	VERIFY2(!m_solving, make_string("do not remove operators during planner update, object %s, id[%d]",
		object_name(), operator_id));
...
{
	VERIFY2(!m_solving, make_string("do not add evaluators during planner update, object %s, id[%d]",
		object_name(), condition_id));
...
{
	VERIFY2(!m_solving, make_string("do not remove evaluators during planner update, object %s, id[%d]",
		object_name(), condition_id));
